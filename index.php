                            ...
                            <div class="col-lg-6 offset-lg-3">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="connexionEtd.php" method="POST">
                                        <div class="form-group"><input class="form-control form-control-user" type="email" placeholder="Nom d'utilisateur" name="NomUser"></div>
                                    ...
                                    <div class="text-center"><a class="small" href="connexionEns.php">Allez vers l'espace Admin &gt;&gt;</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
